...
root_folder = "/Users/anandhu/Documents/proxy/DelaunayBrush/Inputs_and_Results/SKETCHES/anandhu"
    ...
    for i, (path, mtype) in enumerate(zip(mesh_paths, mesh_types)):
        ...
        if mtype == 'lines':
            ...
            if final_mesh_path:
                ...
                bt.setMat_balloon(extra_final_obj, extra_final_color, 0)
                bpy.ops.object.shade_smooth()
