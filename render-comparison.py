...
def create_two_sided_material(name="TwoSidedRibbon", front_color=(0.8, 0.1, 0.1, 1), back_color=(0.8, 0.1, 0.1, 1)):
...
folder_path = "/Users/anandhu/Documents/proxy/SIGRAPH-ASIA/VRSculpt-Rendering/heart/rib"
...
for i, path in enumerate(mesh_paths):
    ...
    if bsdf:
        bsdf.inputs["Base Color"].default_value = (0, 0, 0, 1)  # Fully opaque black
